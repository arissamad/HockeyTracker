...
{
    [super viewDidLoad];
    NSLog(@"ConfigTableViewController viewDidLoad");
...
{
    NSLog(@"Config -> File segue");
    // Get the new view controller using [segue destinationViewController].
    // Pass the selected object to the new view controller.
    FileListViewController *fileListViewController = [segue destinationViewController];
    
    [fileListViewController setData:dataHolder];
